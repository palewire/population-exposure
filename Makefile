...
verify: check coverage manifest-check build package-check docs-check ## Run all local CI checks
...
docs: ## Build HTML documentation
	$(RUN_DOCS) sphinx-build -M html docs docs/_build

docs-check: ## Build documentation and fail on warnings
	$(RUN_DOCS) sphinx-build -M html docs docs/_build -W --keep-going -E

linkcheck: ## Check documentation links and fail on warnings
	$(RUN_DOCS) sphinx-build -M linkcheck docs docs/_build -W --keep-going

build-docs: docs ## Build HTML documentation

serve-docs: ## Serve documentation with live reload
	$(RUN_DOCS) sphinx-autobuild -b html docs docs/_build/html
